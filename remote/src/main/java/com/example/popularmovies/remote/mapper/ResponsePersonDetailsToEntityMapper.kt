...
class ResponsePersonDetailsToEntityMapper @Inject constructor() : Function<ResponsePersonDetails, PersonDetailsEntity> {
    ...
    override fun apply(responsePersonDetails: ResponsePersonDetails): PersonDetailsEntity {
        ...
        return PersonDetailsEntity(
            id = responsePersonDetails.id
                ?: NULLABLE_INT_DEFAULT,
            name = responsePersonDetails.name
            ...
            biography = responsePersonDetails.biography
                ?: NULLABLE_STRING_DEFAULT,
            imagePath = responsePersonDetails.profilePath
                ?: NULLABLE_STRING_DEFAULT,
            imdbId = responsePersonDetails.imdbId
                ?: NULLABLE_STRING_DEFAULT
        )
    }
