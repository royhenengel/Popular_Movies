package com.example.popularmovies.ui.view.details.movie.viewmodel
...
class MovieDetailsFragmentViewModel @Inject constructor(
    ...
    val castThumbnailClickedLiveEvent =
        com.example.popularmovies.ui.viewmodel.SingleLiveEvent<ActorInMovieEntity>()
