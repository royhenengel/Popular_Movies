...
abstract class ViewModelModule {
    ...
    @Binds
    @IntoMap
    @ViewModelKey(FilterDialogFragmentViewModel::class)
    internal abstract fun bindFilterDialogFragmentViewModel(viewModel: FilterDialogFragmentViewModel): ViewModel
