...
class ResponseActorInMovieItemToEntityMapper @Inject constructor() : Function<ResponseActorInMovieItem, ActorInMovieEntity> {
    ...
    override fun apply(responseActorInMovieItem: ResponseActorInMovieItem) : ActorInMovieEntity {
        ...
        return ActorInMovieEntity(
                id = responseActorInMovieItem.id ?: NULLABLE_INT_DEFAULT  ,
                name = responseActorInMovieItem.name ?: NULLABLE_STRING_DEFAULT,
                imagePath = responseActorInMovieItem.profilePath ?: NULLABLE_STRING_DEFAULT,
                character = responseActorInMovieItem.character ?: NULLABLE_STRING_DEFAULT
        )
    }
